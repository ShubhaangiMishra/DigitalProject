...
<div class="container">
 <div class="btn-group btn-group-justified" role="group" >
  <div class="btn-group" role="group">
    <a href="signup"><button type="button" class="btn btn-default btn-lg">SignUp</button></a>
  </div>
  
  <div class="btn-group" role="group" >
  <div class="btn-group1">
    <a href="login"><button type="button" class="btn btn-default btn-lg active">LogIn</button></a>
	</div>
  </div>
</div></br>
  <form role="form">
    ...
    <div class="checkbox">
	  ...
	  <label class="password"><a href="forgot">Forgot your password?</a></label>
    </div>
